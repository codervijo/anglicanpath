...
// Ported from genai/src/components/site/parish-finder.tsx. Mounted as an
// Astro island; TanStack <Link> became plain <a href> with trailing slashes
// to match astro.config.mjs trailingSlash: 'always'.
const ParishMap = lazy(() => import("./ParishMap"));
